            ...
            <!-- <xsl:if test="marc:datafield[@tag=245]"> -->
                <h1 class="title" property="name">
                    <!-- <xsl:for-each select="marc:datafield[@tag=245]">
                        ...
                        <!-- <xsl:for-each select="marc:subfield[contains('bfghknps', @code)]">
                            <xsl:choose>
   ...
   <xsl:if test="$DisplayOPACiconsXSLT!='0'">
    ...
    <xsl:call-template name="show-series">
        ...
        <xsl:if test="$display880">
            ...
            <!-- If the tag attribute of the marc:datafield element starts with '6', is not equal to '655', and is not equal to '653', then perform the following transformations -->
<xsl:if test="marc:datafield[substring(@tag, 1, 1) = '6' and not(@tag=655) and not(@tag=653)]">
    <span class="results_summary subjects"><span class="label">Subject(s): </span>
        <xsl:for-each select="marc:datafield[substring(@tag, 1, 1) = '6'][not(@tag=655) and not(@tag=653)]">
            ...
            <xsl:choose>
<!-- Here it ends, but the rest should continue as before -->
...
<xsl:if test="marc:datafield[@tag='020']">
  <!-- Find the first marc:subfield with code 'a' under the marc:datafield with tag '020' that starts with '978' -->
  <xsl:variable name="doab-isbn" select="marc:datafield[@tag='020']/marc:subfield[@code='a'][starts-with(., '978')][1]"/>

  <!-- Check if the 'doab-isbn' variable is not empty -->
  <xsl:if test="$doab-isbn">
    <!-- Create a <span> element with class 'results_summary doab-record' -->
    <span class="results_summary doab-record">
      <!-- Set the 'data-isbn' attribute with the value of the 'doab-isbn' variable -->
      <xsl:attribute name="data-isbn">
        <xsl:value-of select="$doab-isbn"/>
      </xsl:attribute>
    </span>
  </xsl:if>
</xsl:if>
...
<xsl:if test="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')]">
    <span class="results_summary online_resources">
        <span class="label">Online resources: </span>
        <button type="button" class="btn btn-success btn-sm">
            <xsl:variable name="SubqText"><xsl:value-of select="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='q']"/></xsl:variable>
            <a property="url">
                <xsl:choose>
                    <xsl:when test="$OPACTrackClicks='track'">
                        <xsl:attribute name="href">/cgi-bin/koha/tracklinks.pl?uri=<xsl:value-of select="str:encode-uri(marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='u'], true())"/>&amp;biblionumber=<xsl:value-of select="$biblionumber"/></xsl:attribute>
                    </xsl:when>
                    ...
                    <xsl:otherwise>
                        <xsl:attribute name="href">
                            <xsl:if test="not(contains(marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='u'],'://'))">
                                <xsl:choose>
                                    <xsl:when test="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/@ind1=7">
                                        <xsl:value-of select="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='2']"/><xsl:text>://</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/@ind1=1">
                            ...
                            <xsl:value-of select="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='u']"/>
                        </xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
                    ...
                    <xsl:when test="($Show856uAsImage='Details' or $Show856uAsImage='Both') and (substring($SubqText,1,6)='image/' or $SubqText='img' or $SubqText='bmp' or $SubqText='cod' or $SubqText='gif' or $SubqText='ief' or $SubqText='jpe' or $SubqText='jpeg' or $SubqText='jpg' or $SubqText='jfif' or $SubqText='png' or $SubqText='svg' or $SubqText='tif' or $SubqText='tiff' or $SubqText='ras' or $SubqText='cmx' or $SubqText='ico' or $SubqText='pnm' or $SubqText='pbm' or $SubqText='pgm' or $SubqText='ppm' or $SubqText='rgb' or $SubqText='xbm' or $SubqText='xpm' or $SubqText='xwd')">
                        <xsl:element name="img">
                            ...
                            <xsl:attribute name="alt">
                                <xsl:value-of select="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='y']"/>
                            </xsl:attribute>
                            <xsl:attribute name="style">height:100px</xsl:attribute>
                        </xsl:element>
                        <xsl:text></xsl:text>
                    </xsl:when>
                    <xsl:when test="marc:datafield[@tag=856][contains(subfield[@code='3'], 'L-CC') or contains(subfield[@code='3'], 'License') or contains(subfield[@code='3'], 'LL-') or contains(subfield[@code='3'], 'FULL')][1]/subfield[@code='y']">
                        <xsl:call-template name="subfieldSelect">
